    ...
    render() {
        ...
        return (
            <div className="App-center">
                ...
                {/* Cartes */}
                <CartesComponent actif={this.props.joueur.actif} cliqueCarte={(carte) => this.onDiscarte(carte)} ouvert={this.props.ouvert} cartes={this.props.joueur.getCartes()}></CartesComponent>
                {/* Nom en-dessous */}
                {(this.props.moi) &&
                    <p style={{fontSize: '24px', marginBottom: '0px', color: this.props.joueur.actif ? 'rgb(32,166,237)' : 'white'}}>{this.props.joueur.getNom()}</p>
                }
